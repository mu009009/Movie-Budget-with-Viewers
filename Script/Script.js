...
function Averagedraw(each,average)
{
    ...
    var textSubTitle = svg.append("g")
        .attr("class","text")
        .append('text')
        .text('This design shows the hierarchy of data. I hope you could have a blurred impression representative of whether')
        .style('fill','white')
        .attr("x",-100)
        .attr("y",-80)
        .style("font-family","Helvetica")
    ...
    var textSubTitle2nd = svg.append("g")
        .attr("class","text")
        .append('text')
        .text('a higher TV show budget translates into a greater number of viewers . Clicking on the bar to see more detail.')
        .style('fill','white')
        .attr("x",-100)
        .attr("y",-62)
        .style("font-family","Helvetica")
    ...
    var textThirdTitle = svg.append("g")
        .attr("class","text")
        .append('text')
        .text('This part shows data representing the number of viewers and the budget for')
        .style('fill','white')
        .attr("x",-100)
        .attr("y",-80)
        .style("font-family","Helvetica")
    ...
    var textThirdTitle2nd = svg.append("g")
        .attr("class","text")
        .append('text')
        .text('each episode of a TV show. Size means budget, y means number of viewers.')
        .style('fill','white')
        .attr("x",-100)
        .attr("y",-62)
        .style("font-family","Helvetica")
